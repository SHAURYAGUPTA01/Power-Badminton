...
var ground, ground2, right, left, top;
var angle1, angle2;
...
function setup() {
  ...
  ground2 = Bodies.rectangle(width / 2, 500, width, 110, { isStatic: true })
  World.add(world, ground2)

  right = Bodies.rectangle(width - 20, height / 2, 20, height, { isStatic: true })
  World.add(world, right)

  left = Bodies.rectangle(0, height / 2, 20, height, { isStatic: true })
  World.add(world, left)

  top = Bodies.rectangle(width / 2, 0, width, 20, { isStatic: true })
  World.add(world, top)
